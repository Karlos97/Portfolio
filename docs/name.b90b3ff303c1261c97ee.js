...
var phrases = ["Cześć.", "Nazywam sie Karol Minta.", "Jestem Front-End developerem.", "Więcej informacji o mnie oraz projekty znajdziesz poniżej."]; // let textNumb = 1;

var el = document.querySelector(".text-1"); // const el = document.querySelector(`.text-${textNumb}`);
// const fx = new TextScramble(el);

var texts = document.querySelectorAll("div[class^='text-']");
var fx = [];
fx[0] = new TextScramble(texts[0]);
fx[1] = new TextScramble(texts[1]);
fx[2] = new TextScramble(texts[2]); // let textMap = new Map();
// let fx
...
var next = function next() {
  ...
  fx[0].setText(phrases[0], 0).then(function () {
    fx[1].setText(phrases[1], 1).then(function () {
      fx[2].setText(phrases[2], 2).then(function () {});
    }); // setTimeout(next, 2000);
  });
  counter = (counter + 1) % phrases.length; // textNumb +=counter;
};
...
/******/ });
//# sourceMappingURL=name.b90b3ff303c1261c97ee.js.map